<template>
  <div class="order">
    <a-spin :spinning="spinning">
      <a-divider orientation="left" v-if="recored.edit === '1'">公众号信息</a-divider>
      <a-form-model layout="inline" v-if="recored.edit === '1'">
        <a-row>
      ...
      <a-col :span="24" :offset="1" v-if="recored.edit === '1'" style="margin-top: 24px;">
...
export default class Order extends Vue {
  ...
  private watchRecored(value: any) {
    this.$nextTick(() => {
      console.log(value)
      this.accountInfo = [
        { label: '公众号', value: value.accountName },
        { label: '公众号ID', value: value.accountId },
        { label: '所属类别', value: value.accountTypeName },
        { label: '所属地区', value: value.areaName },
        { label: '首条刊例', value: value.firstPrice, color: '#00a0e9' },
        { label: '首条成本', value: value.firstCost, color: '#ff0012' },
        { label: '次条刊例', value: value.secondPrice, color: '#00a0e9' },
        { label: '次条成本', value: value.secondCost, color: '#ff0012' },
        { label: '3-N刊例', value: value.threePrice, color: '#00a0e9' },
        { label: '3-N成本', value: value.threeCost, color: '#ff0012' },
        {
          label: '公众号属性',
        ...
        {
          label: '公众号分类',
          value: value.accountState === 1 ? '订阅号' : '服务号'
        },
        { label: '所属公司', value: value.company },
