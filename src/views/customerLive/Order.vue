<template>
  <div class="order">
    <a-spin :spinning="spinning">
      <a-divider orientation="left" v-if="recored.edit === '1' || recored.edit === '2'">直播号信息</a-divider>
...
export default class Order extends Vue {
  ...
  private watchRecored(value: any) {
    this.$nextTick(() => {
      console.log(value)
      this.accountInfo = [
        { label: '直播号', value: value.accountName },
        { label: '直播号ID', value: value.accountId },
        ...
        {
          label: '直播号属性',
          value: value.accountState === 9 ? '直播号' : ''
        },
        { label: '所属平台', value: value.terrace },
