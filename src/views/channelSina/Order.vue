<template>
  <div class="order">
    <a-form-model layout="inline" :rules="rules" ref="ruleForm" :model="form">
      <a-row>
        <a-col :span="12">
          <a-form-model-item label="微博号" prop="accountName">
            <a-input style="width: 240px;" v-model="form.accountName" placeholder="请输入微博号名字" />
          </a-form-model-item>
        </a-col>
        ...
        <a-col :span="12">
          <a-form-model-item label="微任务直发刊例" prop="firstPrice">
            <a-input style="width: 240px;" v-model="form.firstPrice" placeholder="请输入微任务直发刊例" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="微任务直发成本" prop="firstCost">
            <a-input style="width: 240px;" v-model="form.firstCost" placeholder="请输入微任务直发成本" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="微任务转发刊例" prop="secondPrice">
            <a-input style="width: 240px;" v-model="form.secondPrice" placeholder="请输入微任务转发刊例" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="微任务转发成本" prop="secondCost">
            <a-input style="width: 240px;" v-model="form.secondCost" placeholder="请输入微任务转发成本" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="微博号属性" prop="accountType">
            <a-select style="width: 240px" v-model="form.accountType" placeholder="请选择微博号号属性">
        ...
        <!-- <a-col :span="12">
          <a-form-model-item label="微博号号分类" prop="accountState">
            <a-select style="width: 240px" v-model="form.accountState" placeholder="请选择微博号号分类">
...
export default class Order extends Vue {
  ...
  private data() {
    return {
      ...
      form: {
        accountName: undefined, // 微博号号名字
        accountId: undefined, // 微博号号ID
        ...
        accountType: undefined, // 微博号号属性
        accountState: 4, // 微博号号分类 1订阅号 2服务号 3 微博号 4 微博号 5小红书 6 微博号号 7 快手号  8美拍号 9直播号
        remark: undefined, // 备注
        phone: undefined, // 微博号号电话（都有）
        kouKou: undefined, // 微博号号扣扣（都有）
        weiXin: undefined, // 微博号号微信（都有）
        company: undefined, // 公司
        durationTime: undefined, // 视频时长（直播、抖音、微博号，美拍号）
        isStarmap: undefined, // 是否星图（抖音）
        retentionTime: undefined, // 保留时长（快手、抖音、微博号，美拍号）
