      ...
      <a-row>
        <a-col :span="12">
          <a-form-model-item label="公众号" prop="accountName">
            <a-input style="width: 240px;" v-model="form.accountName" placeholder="请输入公众号名字" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="公众号ID" prop="accountId">
            <a-input style="width: 240px;" v-model="form.accountId" placeholder="请输入公众号ID" />
          </a-form-model-item>
        </a-col>
        ...
        <a-col :span="12">
          <a-form-model-item label="首条刊例" prop="firstPrice">
            <a-input style="width: 240px;" v-model="form.firstPrice" placeholder="请输入首条刊例" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="首条成本" prop="firstCost">
            <a-input style="width: 240px;" v-model="form.firstCost" placeholder="请输入首条成本" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="次条刊例" prop="secondPrice">
            <a-input style="width: 240px;" v-model="form.secondPrice" placeholder="请输入次条刊例" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="次条成本" prop="secondCost">
            <a-input style="width: 240px;" v-model="form.secondCost" placeholder="请输入次条成本" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="3-N刊例" prop="threePrice">
            <a-input style="width: 240px;" v-model="form.threePrice" placeholder="请输入3-N刊例" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="3-N成本" prop="threeCost">
            <a-input style="width: 240px;" v-model="form.threeCost" placeholder="请输入3-N成本" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="公众号属性" prop="accountType">
            <a-select style="width: 240px" v-model="form.accountType" placeholder="请选择公众号属性">
        ...
        <a-col :span="12">
          <a-form-model-item label="公众号分类" prop="accountState">
            <a-select style="width: 240px" v-model="form.accountState" placeholder="请选择公众号分类">
  ...
  private data() {
    return {
      ...
      form: {
        ...
        accountState: undefined, // 公众号分类 1订阅号 2服务号 3 B站 4 微博号 5小红书 6 抖音号 7 快手号  8美拍号 9直播号
        remark: undefined, // 备注
        phone: undefined, // 公众号电话（都有）
        kouKou: undefined, // 公众号扣扣（都有）
        weiXin: undefined, // 公众号微信（都有）
