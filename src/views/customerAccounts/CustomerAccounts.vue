            ...
            <a-row type="flex" justify="space-between">
              ...
              <a-col :span="6">
                <a-form-model-item label="公众号属性" prop="accountType">
                  <a-select style="width: 160px" v-model="form.accountType" placeholder="请选择公众号属性">
              ...
              <a-col :span="6">
                <a-form-model-item label="公众号分类" prop="accountState">
                  <a-select style="width: 163px" v-model="form.accountState" placeholder="请选择公众号分类">
                    <a-select-option value>全部</a-select-option>
  ...
  private handleImport() {
    if (this.selectedRowKeys) {
      accountExcel({
        ...
        link.download = `公众号导出 + ${new Date().getTime()}`
        link.click()
      })
    }
  }
