<template>
  <div class="order">
    <a-form-model layout="inline" :rules="rules" ref="ruleForm" :model="form">
      <a-row>
        <a-col :span="12">
          <a-form-model-item label="B站号" prop="accountName">
            <a-input style="width: 240px;" v-model="form.accountName" placeholder="请输入B站号名字" />
          </a-form-model-item>
        </a-col>
        ...
        <a-col :span="12">
          <a-form-model-item label="B站属性" prop="accountType">
            <a-select style="width: 240px" v-model="form.accountType" placeholder="请选择B站号属性">
        ...
        <!-- <a-col :span="12">
          <a-form-model-item label="B站号分类" prop="accountState">
            <a-select style="width: 240px" v-model="form.accountState" placeholder="请选择B站号分类">
...
export default class Order extends Vue {
  ...
  private data() {
    return {
      ...
      form: {
        accountName: undefined, // B站号名字
        accountId: undefined, // B站号ID
        ...
        accountType: undefined, // B站号属性
        accountState: 3, // B站号分类 1订阅号 2服务号 3 B站 4 微博号 5小红书 6 B站号 7 快手号  8美拍号 9直播号
        remark: undefined, // 备注
        phone: undefined, // B站号电话（都有）
        kouKou: undefined, // B站号扣扣（都有）
        weiXin: undefined, // B站号微信（都有）
