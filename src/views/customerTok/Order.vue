<template>
  <div class="order">
    <a-spin :spinning="spinning">
      <a-divider orientation="left" v-if="recored.edit === '1' || recored.edit === '2'">抖音号信息</a-divider>
...
export default class Order extends Vue {
  ...
  private watchRecored(value: any) {
    this.$nextTick(() => {
      console.log(value)
      this.accountInfo = [
        { label: '抖音号', value: value.accountName },
        { label: '抖音号ID', value: value.accountId },
        ...
        { label: '是否星图', value: value.isStarmap === 0 ? '否' : '是' },
