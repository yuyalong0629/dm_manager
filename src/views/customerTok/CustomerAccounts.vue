  ...
  <div class="customer-accounts">
    <a-spin :spinning="spinning">
            ...
            <a-row type="flex" justify="space-between">
              ...
              <a-col :span="6">
                <a-form-model-item label="抖音号属性" prop="accountType">
                  <a-select style="width: 160px" v-model="form.accountType" placeholder="请选择抖音号属性">
      ...
      >
        ...
        <span slot="accountState" slot-scope="text">{{ text === 6 ? '抖音号' : '' }}</span>
      </a-table>
      <br />
      <a-pagination
        showQuickJumper
  ...
  private handleImport() {
    if (this.selectedRowKeys) {
      accountExcel({
        ...
        link.download = `抖音号导出 + ${new Date().getTime()}`
        link.click()
      })
    }
  }
