<template>
  <div class="order">
    <a-form-model layout="inline" :rules="rules" ref="ruleForm" :model="form">
      <a-row>
        <a-col :span="12">
          <a-form-model-item label="直播号" prop="accountName">
            <a-input style="width: 240px;" v-model="form.accountName" placeholder="请输入直播号名字" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="直播号ID" prop="accountId">
            <a-input style="width: 240px;" v-model="form.accountId" placeholder="请输入直播号ID" />
          </a-form-model-item>
        </a-col>
        ...
        <a-col :span="12">
          <a-form-model-item label="直播号属性" prop="accountType">
            <a-select style="width: 240px" v-model="form.accountType" placeholder="请选择直播号属性">
        ...
        <!-- <a-col :span="12">
          <a-form-model-item label="直播号分类" prop="accountState">
            <a-select style="width: 240px" v-model="form.accountState" placeholder="请选择直播号分类">
        ...
        <a-col :span="12">
          <a-form-model-item label="所属平台" prop="terrace">
            <a-input style="width: 240px;" v-model="form.terrace" placeholder="请输入所属平台" />
          </a-form-model-item>
        </a-col>
...
export default class Order extends Vue {
  ...
  private data() {
    return {
      ...
      form: {
        accountName: undefined, // 直播号名字
        accountId: undefined, // 直播号ID
        ...
        accountType: undefined, // 直播号属性
        accountState: 9, // 直播号分类 1订阅号 2服务号 3 B站 4 微博号 5小红书 6 直播号 7 快手号  8美拍号 9直播号
        remark: undefined, // 备注
        phone: undefined, // 直播号电话（都有）
        kouKou: undefined, // 直播号扣扣（都有）
        weiXin: undefined, // 直播号微信（都有）
