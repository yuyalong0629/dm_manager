<template>
  <div class="order">
    <a-form-model layout="inline" :rules="rules" ref="ruleForm" :model="form">
      <a-row>
        <a-col :span="12">
          <a-form-model-item label="小红书" prop="accountName">
            <a-input style="width: 240px;" v-model="form.accountName" placeholder="请输入小红书" />
          </a-form-model-item>
        </a-col>
        ...
        <a-col :span="12">
          <a-form-model-item label="小红书属性" prop="accountType">
            <a-select style="width: 240px" v-model="form.accountType" placeholder="请选择小红书属性">
  ...
  private data() {
    return {
      ...
      form: {
        ...
        accountState: 5, // 微博号号分类 1订阅号 2服务号 3 微博号 4 微博号 5小红书 6 微博号号 7 快手号  8美拍号 9直播号
        remark: undefined, // 备注
