<template>
  <div class="order">
    <a-form-model layout="inline" :rules="rules" ref="ruleForm" :model="form">
      <a-row>
        <a-col :span="12">
          <a-form-model-item label="美拍号" prop="accountName">
            <a-input style="width: 240px;" v-model="form.accountName" placeholder="请输入美拍号名字" />
          </a-form-model-item>
        </a-col>

        <a-col :span="12">
          <a-form-model-item label="美拍号ID" prop="accountId">
            <a-input style="width: 240px;" v-model="form.accountId" placeholder="请输入美拍号ID" />
          </a-form-model-item>
        </a-col>
        ...
        <a-col :span="12">
          <a-form-model-item label="植入成本" prop="secondCost">
            <a-input style="width: 240px;" v-model="form.secondCost" placeholder="请输入植入成本" />
          </a-form-model-item>
        </a-col>
        ...
        <a-col :span="12">
          <a-form-model-item label="美拍号属性" prop="accountType">
            <a-select style="width: 240px" v-model="form.accountType" placeholder="请选择美拍号属性">
        ...
        <a-col :span="12">
          <a-form-model-item label="是否美拍号" prop="isMeipai">
            <a-select style="width: 240px" v-model="form.isMeipai" placeholder="请选择是否美拍号">
...
export default class Order extends Vue {
  ...
  private data() {
    return {
      ...
      form: {
        accountName: undefined, // 美拍号名字
        accountId: undefined, // 美拍号ID
        ...
        accountType: undefined, // 美拍号属性
        accountState: 8, // 美拍号分类 1订阅号 2服务号 3 美拍 4 微博号 5小红书 6 美拍号 7 快手号  8美拍号 9直播号
        remark: undefined, // 备注
        phone: undefined, // 美拍号电话（都有）
        kouKou: undefined, // 美拍号扣扣（都有）
        weiXin: undefined, // 美拍号微信（都有）
        company: undefined, // 公司
        durationTime: undefined, // 视频时长（直播、抖音、美拍，美拍号）
        isStarmap: undefined, // 是否星图（抖音）
        retentionTime: undefined, // 保留时长（快手、抖音、美拍，美拍号）
