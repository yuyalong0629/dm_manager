...
export default class Order extends Vue {
  ...
  private watchRecored(value: any) {
    this.$nextTick(() => {
      console.log(value)
      this.accountInfo = [
        { label: '小红书', value: value.accountName },
        { label: '所属类别', value: value.accountTypeName },
        { label: '所属地区', value: value.areaName },
        { label: '粉丝数', value: value.fans },
        { label: '原创单推刊例', value: value.firstPrice, color: '#00a0e9' },
        { label: '原创单推成本', value: value.firstCost, color: '#ff0012' },
        { label: '原创合集刊例', value: value.secondPrice, color: '#00a0e9' },
        { label: '原创合集成本', value: value.secondCost, color: '#ff0012' },
        {
          label: '小红书属性',
        ...
        {
          label: '小红书分类',
          value: value.accountState === 5 ? '小红书' : ''
        },
