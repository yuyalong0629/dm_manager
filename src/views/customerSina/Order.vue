<template>
  <div class="order">
    <a-spin :spinning="spinning">
      <a-divider orientation="left" v-if="recored.edit === '1' || recored.edit === '2'">微博号分类信息</a-divider>
...
export default class Order extends Vue {
  ...
  private watchRecored(value: any) {
    this.$nextTick(() => {
      console.log(value)
      this.accountInfo = [
        { label: '微博号分类', value: value.accountName },
        { label: '所属类别', value: value.accountTypeName },
        { label: '所属地区', value: value.areaName },
        { label: '粉丝数', value: value.fans },
        { label: '微任务直发刊例', value: value.firstPrice, color: '#00a0e9' },
        { label: '微任务直发成本', value: value.firstCost, color: '#ff0012' },
        { label: '微任务转发刊例', value: value.secondPrice, color: '#00a0e9' },
        { label: '微任务转发成本', value: value.secondCost, color: '#ff0012' },
        {
          label: '微博号属性',
        ...
        {
          label: '微博号分类',
          value: value.accountState === 4 ? '微博号' : ''
        },
