  ...
  <div class="customer-accounts">
    <a-spin :spinning="spinning">
            ...
            <a-row type="flex" justify="space-between">
              ...
              <a-col :span="6">
                <a-form-model-item label="微博号属性" prop="accountType">
                  <a-select style="width: 160px" v-model="form.accountType" placeholder="请选择微博号属性">
      ...
      >
        ...
        <span slot="accountState" slot-scope="text">{{ text === 4 ? '微博号' : '' }}</span>
      </a-table>
      <br />
      <a-pagination
        showQuickJumper
  ...
  private handleImport() {
    if (this.selectedRowKeys) {
      accountExcel({
        ...
        link.download = `微博号导出 + ${new Date().getTime()}`
        link.click()
      })
    }
  }
