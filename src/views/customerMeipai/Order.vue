<template>
  <div class="order">
    <a-spin :spinning="spinning">
      <a-divider orientation="left" v-if="recored.edit === '1' || recored.edit === '2'">美拍号信息</a-divider>
...
export default class Order extends Vue {
  ...
  private watchRecored(value: any) {
    this.$nextTick(() => {
      console.log(value)
      this.accountInfo = [
        { label: '美拍号', value: value.accountName },
        { label: '美拍号ID', value: value.accountId },
        ...
        { label: '是否M美拍', value: value.isMeipai === 0 ? '否' : '是' },
        ...
        {
          label: '美拍号分类',
          value: value.accountState === 8 ? '美拍号' : ''
        },
